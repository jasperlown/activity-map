...
class Event(db.Model):
	...
	eventLat = db.Column(db.DECIMAL, index=True, unique=False)
	eventLong = db.Column(db.DECIMAL, index=True, unique=False)
	...
	eventRating = db.Column(db.DECIMAL, index=True, unique=False)
